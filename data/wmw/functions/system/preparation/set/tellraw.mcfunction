...
tellraw @a [{"text":"・"},{"text":"人狼","color": "red"},{"text":" : ","color":"reset"},{"score":{"name":"#WMW","objective":"WolfCount"}},{"text":"人"}]

tellraw @a [{"text":"・"},{"text":"参加人数","color": "yellow"},{"text":" : ","color":"reset"},{"score":{"name":"#WMW","objective":"PlayerNumber"}},{"text":"人"}]
