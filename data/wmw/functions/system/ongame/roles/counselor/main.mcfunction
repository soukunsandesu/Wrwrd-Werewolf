...
execute as @a[tag=counselor,scores={CurrentRole=1..2}] if entity @a[scores={counselor=1..,CurrentRole=12}] run function wmw:system/ongame/roles/counselor/switch_to_villager
execute as @a[tag=counselor,scores={CurrentRole=3..11}] if entity @a[scores={counselor=1..,CurrentRole=12}] run function wmw:system/ongame/roles/counselor/switch_to_werewolf
execute as @a[tag=counselor,scores={CurrentRole=13..}] if entity @a[scores={counselor=1..,CurrentRole=12}] run function wmw:system/ongame/roles/counselor/switch_to_werewolf
