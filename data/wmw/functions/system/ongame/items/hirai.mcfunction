...
execute as @e[type=item,nbt={Item:{id:"minecraft:end_rod",tag:{CustomModelData:4}}}] at @s run summon armor_stand ~ ~0.4 ~ {Invisible:1,Marker:0,Tags:["WMWstand","hirai"]}
...
execute as @e[type=item,nbt={Item:{id:"minecraft:lightning_rod",tag:{CustomModelData:11}}}] at @s run summon armor_stand ~ ~0.4 ~ {Invisible:1,Marker:0,Tags:["WMWstand","hirai"]}
