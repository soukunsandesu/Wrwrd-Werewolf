...
execute as @e[type=arrow,nbt={CustomPotionEffects:[{Id:30b,Amplifier:60b}]}] at @s[nbt={inGround:true}] run playsound entity.generic.explode master @a ~ ~ ~ 5 0 1
execute as @e[type=arrow,nbt={CustomPotionEffects:[{Id:30b,Amplifier:60b}]}] at @s[nbt={inGround:true}] run playsound entity.generic.extinguish_fire master @a ~ ~ ~ 5 0 1
execute as @e[type=arrow,nbt={CustomPotionEffects:[{Id:30b,Amplifier:60b}]}] at @s[nbt={inGround:true}] run playsound entity.generic.extinguish_fire master @a ~ ~ ~ 5 0 1
...
execute at @e[nbt={ActiveEffects:[{Id:30b,Amplifier:60b}]}] run playsound entity.generic.explode master @a ~ ~ ~ 5 0 1
execute at @e[nbt={ActiveEffects:[{Id:30b,Amplifier:60b}]}] run playsound entity.generic.extinguish_fire master @a ~ ~ ~ 5 0 1
execute at @e[nbt={ActiveEffects:[{Id:30b,Amplifier:60b}]}] run playsound entity.generic.extinguish_fire master @a ~ ~ ~ 5 0 1
