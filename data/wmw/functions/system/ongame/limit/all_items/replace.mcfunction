...
loot replace entity @s hotbar.0 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.1 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.2 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.3 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.4 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.5 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.6 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.7 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s hotbar.8 loot wmw:item/light_gray_staind_glass_pane
loot replace entity @s weapon.offhand loot wmw:item/light_gray_staind_glass_pane