...
execute as @a[scores={DeathCount=1,CurrentRole=3..}] run scoreboard players remove #WMWAfter VillageCount 1
execute if score #Haunting wrwrSettings matches 1 if score #WMWAfter WolfCount matches 1.. if score #WMWAfter VillageCount matches 1.. unless entity @e[type=minecraft:armor_stand,tag=HauntPlayer_Teleporter] as @a[scores={Haunting=1..,DeathCount=1}] at @s run function wmw_after:system/ongame/roles/haunting/death
execute if score #WMWAfter WolfCount matches 1.. if score #WMWAfter VillageCount matches 1.. if entity @a[scores={CurrentRole=8..9,DeathCount=1}] as @a[scores={CurrentRole=8..9,DeathCount=0}] run function wmw_after:system/ongame/roles/brothers/death
...
execute if score #Detective wrwrSettings matches 1 as @a[scores={DeathCount=1}] run function wmw_after:system/ongame/create_deadbody
...
# fake book
execute if score #Thief wrwrSettings matches 1 run function wmw_after:system/ongame/roles/fake

# 酔っぱらい
execute if score #Drunk wrwrSettings matches 1 run function wmw_after:system/ongame/roles/drunk/main

# 地縛霊
execute if score #Haunting wrwrSettings matches 1 run function wmw_after:system/ongame/roles/haunting/main

# 青陰キャ
execute if score #radaokun wrwrSettings matches 1 at @a[scores={CurrentRole=7,DeathCount=0}] run function wmw_after:system/ongame/roles/radaokun

# 兄弟
execute if score #Brother wrwrSettings matches 1 if entity @a[scores={CurrentRole=8..9,DeathCount=0,CountDown=1..}] run function wmw_after:system/ongame/roles/brothers/main

# イタコ
execute if score #Itako wrwrSettings matches 1 run function wmw_after:system/ongame/roles/itako

# 探偵
execute if score #Detective wrwrSettings matches 1 run function wmw_after:system/ongame/roles/detective/
...
# スタングレネード
#function wmw_after:system/ongame/items/snowball

# 煙玉
function wmw_after:system/ongame/items/smoke

# フォースライトニング
#function wmw_after:system/ongame/items/force_lightning
...
# UAV
#execute if score #Thief wrwrSettings matches 1 run function wmw_after:system/ongame/items/
