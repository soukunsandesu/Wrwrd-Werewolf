...
execute at @e[type=minecraft:armor_stand,tag=HauntPlayer_Teleporter] run loot replace entity @a[scores={Haunting=1..,DeathCount=1..}] armor.head loot wmw_after:item/zombie_head
...
execute as @a[scores={Haunting=1..,DeathCount=1..}] run function wmw_after:system/ongame/limit/all_items/main
