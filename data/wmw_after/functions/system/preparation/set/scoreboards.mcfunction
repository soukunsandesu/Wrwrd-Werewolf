...
execute if score #Thief wrwrSettings matches 1 run scoreboard players set #WMWAfter Phase 1
execute if score #Thief wrwrSettings matches 0 run function wmw_after:system/ongame/change_to3
